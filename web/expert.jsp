        ...
        <section class="gallery py-5" id="gallery">
            <div class="container py-lg-5" style="display: flex">
                <div class="col-lg-9 left-blog-info text-left">
                    <h2 class="heading text-center mb-sm-5 mb-4">Chuyên gia </h2>
                    <div style="text-align: end">Ngày Đăng: ${a.expect1.timepost}</div>
                    <div class="row news-grids text-center">
                        <div class="row item-list">
                            ...
                            <div class="form-content">
                                ...
                                <div class="image">
                                    <img src="${a.expect1.image2}" width="900" height="600"/>
                                </div>
                            </div>        
                            ...
                            <div class="form-content">
                                ...
                                <div class="image">
                                    <img src="${a.expect1.image3}" width="900" height="600"/>
                                </div>
                            </div>
                            ...
                            <div class="form-content">
                                ...
                                <div class="image">
                                    <img src="${a.expect1.image4}" width="900" height="600"/>
                                </div>
                            </div>
