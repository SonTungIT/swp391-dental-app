...
import sample.informattion.KnowledgeDAO;
import sample.informattion.KnowledgeDTO;

/**
 *
 * @author QUANG VAN
 */
@WebServlet(name = "DetailKnowledgeController", urlPatterns = {"/DetailKnowledgeController"})
public class DetailKnowledgeController extends HttpServlet {
